...
class AHKLintTest extends TestCase {
	...
	@Test_checkOpeningTrueBrace() {
		...
		Line.addLine("    Hotkey, IfWinActive, ahk_class Notepad", 35)
		Line.addLine("    Hotkey IfWinActive, ahk_class Notepad", 36)
		Line.addLine("    Hotkey If, % fn", 37)
		Line.addLine("    Hotkey, If, % fn", 38)
		Line.addLine("; @todo Define functions (e.g. callbacks for parser)", 39)
		Line.addLine("", 40)
		Statement.check()
		Ansi.flush()
		this.assertEquals(TestCase.fileContent(A_Temp "\ahklint-test.err")
